        ...
        <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Men</span></a>
                        ...
                        <div class="cate-head-sub-container">
                            <ul>
                                <li>
                                    <div class="cate-head">
                                        <a href="" class="cate-head-a"
                                            style="color: #000; font-weight: 500;">Clothing</a>
                                    </div>
                                    <div class="cate-sub">
                                        <ul style="display: inline-block; font-size: 14px; margin-top: 10px;">
                                            <li>
                                            ...
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Formal Shirts</span></a>
                                            </li>
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Casual Shirts</span></a>
                                            </li>
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                ...
                                <li>
                                    <div class="cate-head">
                                        <a href="" class="cate-head-a"
                                            style="color: #000; font-weight: 500;"><span>Bags</span></a>
                                    </div>
                                    <div class="cate-sub">
                                        <ul style="display: inline-block; font-size: 14px; margin-top: 10px;">
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Backpacks</span></a>
                                            </li>
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Messenger Bags</span></a>
                                            </li>
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Duffle Bags</span></a>
                                            </li>
                                            <li>
                                                <a href="product-filter.html" class="cate-sub-a"
                                                    style="color: #000;"><span>Crossbody Bags</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Women Pahiran</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
                                <li>
                                    <div class="cate-head">
                                        <a href="" class="cate-head-a"
                                            style="color: #000; font-weight: 500;"><span>Clothing</span></a>
                                    </div>
                                    <div class="cate-sub">
                                        <ul style="display: inline-block; font-size: 14px; margin-top: 10px;">
                                            <li>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Kids</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Beauty</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Home & Living</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Electronic Devices</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Electronic Accessories</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
            ...
            <li>
                <div class="cate-show-title">
                    <a href=""><span class="cate-show-title-design">Photography</span></a>
                    <div class="cate-container"
                        style="position: absolute; display:flex; align-items:center; z-index: 99999; background-color: #fff; padding: 20px 20px;">
                        <div class="cate-head-sub-container">
                            <ul>
